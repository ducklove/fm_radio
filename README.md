...
- **공개 모델** — 튜너 3종, 이퀄라이저 2종, 앰프 6종, 카세트 데크 5종, 턴테이블 4종(선택 모델 총 20종) + 단일 오디오 타이머 DT-540
- **모델 정체성** — 공개 자료에서 확인되는 실물의 비례·재질·대표 조작을 기준으로 SVG를 구성하며, 8B TRIBUTE·91E TRIBUTE·E-303 TRIBUTE만 여러 시대의 설계 언어와 앱 기능을 결합한 창작 재해석이다
...
```
index.html          본체 문서 셸
styles.css         공통 레이아웃·반응형·기기 UI 스타일
app.js              선국·턴테이블·음반 수납장·화면 상태
...
두 보기를 오간다 — **튜너형**(로컬 `widget.html` 미니 플레이어, 트레이 옆 소형 창)과
**오디오 시스템**(배포판 전체 하이파이 랙 `index.html`, 전체 화면). 각 보기의
